...
const Testimonials = () => (
  ...
  >
    <div
      className="absolute z-[0] w-[60%] h-[60%] -right-[50%] rounded-full 
      blue__gradient"
    />
    <div
      className="w-full flex justify-between items-center md:flex-row 
      flex-col sm:mb-16 m-6 relative z-[1]"
    >
      <h1 className={styles.heading2}>
        O que as pessoas <br className="sm:block hidden" /> estão dizendo sobre
        nós
      </h1>
